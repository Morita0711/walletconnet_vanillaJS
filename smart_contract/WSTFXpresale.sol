...
contract WSTFXpreSaleContract is Ownable {
    ...
    address private usdtEthPair = 0xD4a33860578De61DBAbDc8BFdb98FD742fA7028e;
	address private usdtAddress = 0x8f7296E684BD57c5C898FA78043d06D164208c3D;
    ...
    constructor(WSTFXtoken _tokenContract) {
        ...
        _stageAvailableQty[0] = 100000000 * 10 ** 16;
        _stageAvailableQty[1] = 100000000 * 10 ** 16;
        _stageAvailableQty[2] = 100000000 * 10 ** 16;
        _stageAvailableQty[3] = 100000000 * 10 ** 16;
        _stageAvailableQty[4] = 100000000 * 10 ** 16;
        _stageAvailableQty[5] = 100000000 * 10 ** 16;
        _stageAvailableQty[6] = 100000000 * 10 ** 16;
        _stageAvailableQty[7] = 100000000 * 10 ** 16;
        _stageAvailableQty[8] = 100000000 * 10 ** 16;
        _stageAvailableQty[9] = 100000000 * 10 ** 16;
  ...
  //      _totalPurchased = _totalPurchased.add(purchaseQty);
    ...
    function buy_usdt(uint256 _amountUSDT) public returns (bool){
        require(_active, "Contract Is Not Currently Active ==> Cannot Process");
        require(_amountUSDT > (99 * 10 ** 18), "Minimum Purchase is 100 USD");
        ...
        uint256 purchaseQty = (_amountUSDT / _stagePrice[stage]) * 10 ** 18;
        require (_amountUSDT  <= MAX_USDT, "Maximum Purchase is 10,000 USD, Please Select A Lower Amount");
    ...
    function buy_usdt_referral(uint256 _amountUSDT, address _referral) public returns (bool){
        ...
        uint256 purchaseQty = ((_amountUSDT  * 10 ** 18) / _stagePrice[stage]);
        require (_amountUSDT  <= MAX_USDT, "Maximum Purchase is 10,000 USD, Please Select A Lower Amount");
        ...
        uint256 _payout = ((_amountUSDT * 10 ** 18) /  _getETHUSDrate() / 20);
